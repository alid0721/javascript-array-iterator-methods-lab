...
// Complete the exercise in the space below:
// sortedByBirthYear=inventors.sort((element,index)=>{
//     if (element[index].year<element[index+1].year){
//         return element[index]
//     }
//     else{
//         const tempelement=element[index]
//         element[index]=element[index+1]
//         element[index+1]=tempelement
//         return element[index]
//     }
// })
...
firstLast=people.map((element)=>{
    const [lastname,firstname] =element.split(",")
...
isAdultPresent=devs.some((element)=>{
  return (currentYear-element.year>=18)
})
// Check your work:
...
// Complete the exercise in the space below:
isEveryone19OrOlder=devs.every((element)=>{currentYear-devs.year>18})
// Check your work:
